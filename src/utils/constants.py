...
LOWER_THIRD_HEIGHT_RATIO = 0.30
LOWER_THIRD_LOGO_WIDTH_RATIO = 0.10
LOWER_THIRD_LOGO_MAX_HEIGHT_RATIO = 0.80
LOWER_THIRD_SEPARATOR_WIDTH = 1
LOWER_THIRD_TEXT_MARGIN = 16
LOWER_THIRD_REF_ROW_HEIGHT = 36   # px reserved for reference label
LOWER_THIRD_REF_FONT_MAX = 24.0   # max pt for reference font scan
LOWER_THIRD_REF_FONT_RATIO = 0.60  # legacy fallback, no longer primary
