...
class ChannelSettings:
    ...
    theme_id: str = "dark_gold"  # stored as "theme" key in JSON
    ...
    ndi_source_name: str = "VerseFlow Main"  # per-channel default overridden on read
...
class SettingsManager:
        ...
        defaults = {
            ...
            "channels": {
                "main": {
                    ...
                    "ndi": {"enabled": True, "source_name": "VerseFlow Main"},
                },
                "alt": {
                    "enabled": True,
                    "mode": "lower_third",
                    ...
                    "monitor": None,
                    "lower_third": {"logo_path": None, "show_logo_placeholder": True},
                    "ndi": {"enabled": True, "source_name": "VerseFlow Alt"},
                },
            },
        }
    ...
    def get_channel_settings(self, channel_name: str) -> ChannelSettings:
        ...
        # Infer default source name based on channel name for backward compat
        default_source = f"VerseFlow {channel_name.capitalize()}"
        ...
        return ChannelSettings(
            ...
            theme_id=ch.get("theme") or "dark_gold",
            monitor=ch.get("monitor"),
            logo_path=lt.get("logo_path"),
            show_logo_placeholder=lt.get("show_logo_placeholder", True),
            ndi_enabled=ndi.get("enabled", True),
            ndi_source_name=ndi.get("source_name", default_source),
        )
